...
RUN git clone https://github.com/OCA/dms.git /mnt/extra-addons/dms -b 16.0
RUN git clone https://github.com/OCA/server-backend.git /mnt/extra-addons/server-backend -b 16.0
...
RUN git clone https://github.com/OCA/knowledge.git /mnt/extra-addons/knowledge -b 16.0

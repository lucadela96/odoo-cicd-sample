...
RUN git clone https://github.com/OCA/purchase-workflow.git /mnt/extra-addons/purchase-workflow -b 15.0
RUN git clone https://github.com/OCA/reporting-engine.git /mnt/extra-addons/reporting-engine -b 15.0
RUN git clone https://github.com/OCA/field-service.git /mnt/extra-addons/field-service -b 15.0
